...
import {
  Clock, Plus, Trash2, Calendar, Coffee, AlertTriangle, Save,
...
export default function AssistantSchedulePage() {
  ...
  useEffect(() => {
    ...
    setSlots([
      ...
      { id: '3', day: 'Monday', time: '10:00 - 10:20', active: true },
      { id: '4', day: 'Tuesday', time: '10:00 - 10:20', active: true },
      { id: '5', day: 'Wednesday', time: '11:00 - 11:20', active: true },
    ]);
  }, []);
  ...
  return (
    <div className="max-w-5xl mx-auto py-6">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: 'var(--text-secondary)' }}>
            Configure working hours, breaks, and daily limits for the official desk.
          </p>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="glass-card rounded-2xl p-5 border border-white/5">
            <h3 className="text-xs font-bold uppercase tracking-widest text-amber-400 mb-4 flex items-center gap-1.5">
              <Plus size={14} /> Create Weekly Recurring Time Slot
            </h3>
            <form onSubmit={handleAddSlot} className="grid grid-cols-2 sm:grid-cols-4 gap-3 items-end">
              ...
              <div>
                <label className="block text-[10px] font-bold uppercase tracking-wider text-zinc-400 mb-2">Duration (mins)</label>
                <select
                  value={duration}
        ...
        {/* Right Column: Office Hours & Breaks */}
        <div className="flex flex-col gap-6">
          ...
          <div className="glass-card rounded-2xl p-5 border border-white/5 flex flex-col gap-4">
            <h3 className="text-xs font-bold uppercase tracking-widest text-amber-400 flex items-center gap-1.5">
              <Clock size={14} /> Secretariat Controls
            </h3>
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">
              <div>
                <label className="block font-semibold mb-1 text-zinc-400">Lunch Hour Start</label>
              ...
              <div>
                <label className="block font-semibold mb-1 text-zinc-400">Lunch Hour End</label>
            ...
            <div className="text-xs">
              <label className="block font-semibold mb-1.5 text-zinc-400">Max Appointments / Day</label>
              <input
                type="number"
            ...
            >
              <Save size={13} /> Save Schedule Parameters
            </button>
          </div>
        </div>
      </div>
